...
menu = [{'title': "Статистика", 'url': 'home',   'icon': 'fas fa-chart-pie', 'list': {}},
        ...
        {'title': "Фільми",     'url': 'listfilms', 'icon': 'fa-sharp fa-solid fa-film', 'list': {}},
        {'title': "Кінотеатри", 'url': 'addcinema', 'icon': 'fa-solid fa-user',   'list': {'Список кінотеатрів':"home",'Добавити кінотеатр':"addcinema", 'Добавити зал':"addhall"}},
        {'title': "Новини",     'url': 'listnews', 'icon': 'fa-solid fa-newspaper', 'list': {}},
